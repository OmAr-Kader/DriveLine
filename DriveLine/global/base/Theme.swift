...
struct Theme {
    ...
    var primary: Color { .primaryOfApp }
    var secondary: Color { .secondary }
    var background: Color { .background }
    var surface: Color { .surfaceOfApp }
    var backDark: Color { .backDark }
    var backDarkSec: Color { .backDarkSec }
    var backGreyTrans: Color { .backGreyTrans }
    var textColor: Color { .textOfApp }
    var textForPrimaryColor: Color { .textForPrimary }
    var textGrayColor: Color { .textGray }
    var error: Color { .error }
    var textHintColor: Color { .textHint }
    var textHintAlpha: Color { .textHintAlpha }
    var backDarkAlpha: Color { .backDarkAlpha }
    var primaryAlpha: Color { .primaryAlpha }
    var backgroundPrimary: Color { .backgroundPrimary }
    var pri: Color { .primarySingle }
    var seenColor: Color { .seen }
    ...
    @MainActor
    var toOutlinedColor: OutlinedColor {
        OutlinedColor(isDarkMode: isDarkMode, textColor: textColor, textHintColor: textHintColor, primary: primary, textForPrimaryColor: textForPrimaryColor, secondary: secondary, error: error)
    }
    
    
    @MainActor
    var toPagerTabColor: PagerTabColor {
        PagerTabColor(background: background, primary: primary, secondary: secondary, textForPrimaryColor: textForPrimaryColor)
    }
    
    @MainActor
    var toMultipleFloatingColor: MultipleFloatingColor {
        MultipleFloatingColor(isDarkMode: isDarkMode, primary: primary, secondary: secondary, textForPrimaryColor: textForPrimaryColor)
    }
}
