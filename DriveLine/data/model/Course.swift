...
struct ProvideCourseRequest: Codable {
    ...
    init(data: ProvideCourseData) {
        self.init(techId: data.techId, courseAdminId: data.courseAdminId, description: data.description, price: data.price, currency: data.currency, sessions: data.sessions, images: data.images, monday: data.monday, tuesday: data.tuesday, wednesday: data.wednesday, thursday: data.thursday, friday: data.friday, saturday: data.saturday, sunday: data.sunday)
    }
